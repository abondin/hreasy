...
ALTER TABLE empl.employee ADD COLUMN telegram varchar(255) NULL;
ALTER TABLE empl.employee_history ADD COLUMN telegram varchar(255) NULL;


COMMENT ON COLUMN empl.employee.telegram IS
'Telegram account';
COMMENT ON COLUMN empl.employee_history.telegram IS
'Telegram account';
