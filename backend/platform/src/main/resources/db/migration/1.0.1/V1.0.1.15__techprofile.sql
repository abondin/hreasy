...
COMMENT ON COLUMN techprofile.techprofile_log.content_length IS 'The content length in bytes';
...
INSERT INTO sec.perm (permission,description) VALUES
	 ('techprofile_download','Download employee tech profile') on conflict do nothing;
INSERT INTO sec.role_perm (role,permission) VALUES
	 ('global_admin','techprofile_download'),
	 ('pm','techprofile_download'),
	 ('hr','techprofile_download') on conflict do nothing;

INSERT INTO sec.perm (permission,description) VALUES
	 ('techprofile_upload','Upload employee tech profile') on conflict do nothing;
INSERT INTO sec.role_perm (role,permission) VALUES
	 ('global_admin','techprofile_upload'),
	 ('pm','techprofile_upload'),
	 ('hr','techprofile_upload') on conflict do nothing;
