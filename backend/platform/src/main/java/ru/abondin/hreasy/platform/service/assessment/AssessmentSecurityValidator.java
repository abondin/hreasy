...
public class AssessmentSecurityValidator {
    ...
    private final ProjectHierarchyAccessor hierarchyAccessor;
    ...
    public Mono<Boolean> validateOwnerOrCanViewAssessmentFull(AuthContext auth, int employee, List<Integer> assessmentOwners) {
        return Mono.defer(() -> {
