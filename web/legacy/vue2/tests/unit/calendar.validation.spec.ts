 ...
 */
const daysNotIncludedInVacation = ["2022-01-01", "2022-01-02", "2022-01-03", "2022-01-04", "2022-01-05", "2022-01-06", "2022-01-07", "2022-01-08", "2022-02-23", "2022-03-08", "2022-05-01", "2022-05-09", "2022-06-12", "2022-11-04", "2023-01-01", "2023-01-02", "2023-01-03", "2023-01-04", "2023-01-05", "2023-01-06", "2023-01-07", "2023-01-08", "2023-02-23", "2023-03-08", "2023-05-01", "2023-05-09", "2023-06-12", "2023-11-04"];
...
const testData = testDataRaw.map((line, index) => {
    ...
    // Uncomment code block to sort all dates and remove duplicates
    //     .sort((a, b) => {
    //         if (a.start > b.start) {
    //             return 1;
...
describe("Vacation days validation", () => {
        it.each(testData
            ...
            expect(args[4]).toBe(args[3] as number)
        );
    }
);
