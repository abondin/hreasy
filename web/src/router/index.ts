...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/salaries/requests", name: "salary-requests", component: SalaryRequestsView, meta: { requiresAuth: true, keepAlive: true } },
    { path: "/salaries/latest", name: "salary-latest", component: SalaryLatestRequestsView, meta: { requiresAuth: true, keepAlive: true } },
    {
    ...
    { path: "/admin/projects", name: "admin-projects", component: AdminProjectsView, meta: { requiresAuth: true, keepAlive: true } },
    {
    ...
    { path: "/admin/ba", name: "admin-business-accounts", component: AdminBusinessAccountsView, meta: { requiresAuth: true, keepAlive: true } },
    {
    ...
    { path: "/admin/managers", name: "admin-managers", component: AdminManagersView, meta: { requiresAuth: true, keepAlive: true } },
    { path: "/admin/articles", name: "admin-articles", component: AdminArticlesView, meta: { requiresAuth: true, keepAlive: true } },
    { path: "/admin/users", name: "admin-users", component: AdminUsersView, meta: { requiresAuth: true, keepAlive: true } },
    {
