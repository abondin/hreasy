...
COMMENT ON COLUMN dict.department_log.deleted is 'Show that the entry was deleted';
...
COMMENT ON COLUMN dict.level_log.deleted is 'Show that the entry was deleted';
...
COMMENT ON COLUMN dict.position_log.deleted is 'Show that the entry was deleted';
...
COMMENT ON COLUMN dict.office_location_log.deleted is 'Show that the entry was deleted';
