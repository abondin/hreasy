...
if not exists (select * from sec_perm where permission='edit_employee_full')
    begin
        ...
        insert into sec_role_perm(role,permission) values ('global_admin','view_employee_full');
        ...
        insert into sec_role_perm(role,permission) values ('hr','edit_employee_full');
end
GO