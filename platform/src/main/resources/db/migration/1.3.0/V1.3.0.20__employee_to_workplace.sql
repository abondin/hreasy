...
ALTER TABLE empl.employee_history ADD COLUMN IF NOT EXISTS office_workplace integer null;
COMMENT ON COLUMN empl.employee.office_workplace IS 'Link to office workplace';
COMMENT ON COLUMN empl.employee_history.office_workplace IS 'Link to office workplace';
