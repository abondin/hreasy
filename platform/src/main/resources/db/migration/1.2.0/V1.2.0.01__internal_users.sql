...
ALTER TABLE sec.login_history ADD COLUMN
...
CREATE TABLE IF NOT EXISTS sec.passwd (
    ...
    passwd_hash VARCHAR(1024) NOT NULL,
...
COMMENT ON COLUMN sec.passwd.passwd_hash IS 'Hash of the password';
...
COMMENT ON COLUMN sec.passwd_history.passwd_hash IS 'Hash of the password';
